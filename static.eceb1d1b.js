...
})(['display:flex;align-items:flex-start;flex-wrap:wrap;margin-bottom:1rem;> a{width:30%;text-align:center;font-size:0.833rem;font-weight:normal !important;color:#828282 !important;padding:0.1rem 0;border:1px solid #edebeb;margin-right:5px;margin-bottom:5px;transition:all 0.2s cubic-bezier(0.25,0.46,0.45,0.94);&:hover{background-color:#edebeb;}}', ''], (0, _styledComponentsBreakpoint2.default)('desktop')(_templateObject2));
...
//# sourceMappingURL=static.eceb1d1b.js.map