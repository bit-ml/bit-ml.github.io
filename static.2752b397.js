...
var _Normalize = __webpack_require__(28);
...
})(['a{text-decoration:none;color:#108db8;font-weight:bold;}nav{width:100%;background:#020100;padding:0 5rem;font-family:Roboto;text-align:right;a{padding:1rem;display:inline-block;font-style:normal;font-weight:500;line-height:23px;font-size:14px;text-align:right;text-transform:uppercase;color:#A8A8A8;}a:last-child{padding-right:0;}}img{max-width:100%;}']);
...
var Hero = exports.Hero = _styledComponents2.default.div.withConfig({
  displayName: 'Hero'
})(['display:inline-block;width:100%;margin:0 auto;height:95vh;padding:0 5rem;background:#020100 url(\'./hero_avatar.jpg\') no-repeat bottom;']);

var Heading = _styledComponents2.default.h1.withConfig({
  displayName: 'Hero__Heading'
})(['max-width:800px;font-family:\'Exo 2\',serif;font-style:normal;font-weight:500;line-height:92px;font-size:64px;color:#E4E4E4;']);
...
})(['display:inline-block;position:relative;max-width:100%;display:flex;justify-content:space-between;']);

var SpecialtyPanel = exports.SpecialtyPanel = _styledComponents2.default.div.withConfig({
  displayName: 'Specialty__SpecialtyPanel'
})(['background:', ';position:sticky;top:0;left:0;display:flex;flex-direction:column;height:100vh;width:38%;overflow:hidden;.specItem{flex-grow:1;flex-shrink:1;flex-basis:auto;justify-content:center;}.specialtyHeading{}'], function (props) {
  return props.bg;
});

var Heading = _styledComponents2.default.h2.withConfig({
  displayName: 'Specialty__Heading'
})(['margin-top:0;font-family:\'Bitter\',serif;font-style:normal;font-weight:400;line-height:81px;font-size:96px;letter-spacing:0.08em;text-transform:uppercase;color:rgba(255,255,255,0.2);']);

var Description = _styledComponents2.default.p.withConfig({
  displayName: 'Specialty__Description'
})(['flex-grow:10;font-family:\'Roboto\',sans-serif;font-style:normal;font-weight:300;line-height:36px;font-size:24px;color:rgba(255,255,255,0.8);padding:0 5rem;']);

var Team = _styledComponents2.default.p.withConfig({
  displayName: 'Specialty__Team'
})(['font-family:Roboto;font-style:normal;font-weight:400;line-height:23px;font-size:14px;color:rgba(255,255,255,0.5);padding:0 5rem;']);
...
})(['padding:0 15rem;display:inline-block;']);
...
})(['padding:0.6rem;margin-left:5px;margin-right:5px;flex:1 1 350px;@supports (display:grid){margin:0;}display:flex;align-items:flex-start;transition:all 0.2s cubic-bezier(0.25,0.46,0.45,0.94);&:hover{background-color:#fff;box-shadow:0px 0px 17px -4px rgba(115,108,108,1);transform:scale(1.05);div>a{opacity:1}}']);
...
})(['display:flex;align-items:flex-start;flex-wrap:nowrap;margin-bottom:1rem;>a{width:33.33%;opacity:0;text-align:center;font-weight:normal !important;color:#828282 !important;padding:0.5rem;border:1px solid #edebeb;margin-right:5px;transition:all 0.2s cubic-bezier(0.25,0.46,0.45,0.94);&:hover{background-color:#edebeb;}}']);
...
})(['display:flex;flex-wrap:wrap;display:grid;grid-template-columns:repeat(auto-fill,minmax(350px,1fr));grid-auto-rows:minmax(150px,auto);grid-gap:3rem;padding:10rem 5rem;background:#F5F2F2;']);
...
//# sourceMappingURL=static.2752b397.js.map